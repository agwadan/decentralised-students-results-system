...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = 1;
        $sql = "INSERT INTO  tblsubjectcombination(ClassId,SubjectId,CU,status) VALUES(:class,:subject,:credit,:status)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':class', $class, PDO::PARAM_STR);
        $query->bindParam(':subject', $subject, PDO::PARAM_STR);
        $query->bindParam(':credit', $cred, PDO::PARAM_STR);
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="credU" class="form-control" id="default" placeholder="Credit Units" required="required">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
