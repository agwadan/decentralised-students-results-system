...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Student Registration Number</label>
<div class="col-sm-10">
<input type="text" name="regnum" class="form-control" id="regnum" value="<?php echo htmlentities($result->RegNum)?>" maxlength="20" required="required" autocomplete="off">
</div>
</div>
