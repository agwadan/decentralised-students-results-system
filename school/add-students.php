...
$dob=$_POST['dob']; 
    ...
    $target_path = $target_path.basename($_FILES['imgUpload']['name']);
    if(move_uploaded_file($_FILES['imgUpload']['tmp_name'],$target_path)){

    

$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,RegNum,StudentEmail,,Gender,ClassId,DOB,image_text,Status) VALUES(:studentname,:roolid,:regno,:studentemail,:gender,:classid,:dob,:img,:status)";
...
$query->bindParam(':img',$target_path,PDO::PARAM_STR);
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Student Id Number</label>
<div class="col-sm-10">
...
<div class="col-sm-10">
<input type="text" name="regnum" class="form-control" id="regnum" maxlength="20" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="file" name="imgUpload" class="form-control" id="imageUpload" required="required" autocomplete="off">
</div>
</div>
