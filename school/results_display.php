...
$std_rollid = $row['RollId'];
$std_regDate = $row['RegDate'];
$std_status = $row['Status'];
$std_class = $row['ClassId'];

$sql2 = "SELECT * FROM tblclasses WHERE id = '$std_class'";
$query2 = mysqli_query($link, $sql2);
$row2 = mysqli_fetch_array($query2);
$cls_name = $row2['ClassName'];
?>



<div class="logo">
    <img src="images/muklogo.jpg" align="middle">
</div>
<p><b>Student Name :</b> <?php echo htmlentities($std_name);?></p>
<p><b>Student Id Number :</b> <?php echo htmlentities($std_rollid);?>
<p><b>Student Program:</b> <?php echo htmlentities($cls_name);?>(<?php echo htmlentities($row->Section);?>)
<?php 
...
/*$sql = "SELECT * FROM tblresult WHERE StudentId = '$rollid'";
$query1 = mysqli_query($dbh, $sql);
...
<?php
echo htmlentities("Invalid Student Id Number");
 }
?>
                                        </div>
