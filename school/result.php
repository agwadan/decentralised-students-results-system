                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="panel">
                                        ...
                                        <div class="logo">
    <img src="images/maklogo.png" alt="logo2">
</div>
                                                ...
                                                <div class="panel-body p-20">
                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sql = "SELECT   tblresult.Grade,tblresult.StudentId,tblstudents.StudentId,tblstudents.RollId from tblresult join tblstudents on tblresult.StudentId=tblstudents.StudentId where tblstudents.RollId=:rollid";
                                                            $qury = $dbh->prepare($sql);
                                                            $qury->bindParam(':rollid', $rollid, PDO::PARAM_STR);
                                                            $qury->execute();
                                                            $res = $qury->fetchAll(PDO::FETCH_OBJ);
...
?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><b><?php echo htmlentities($finalgpa); ?></b></td>
                                                                </tr>
                                                                <tr>
